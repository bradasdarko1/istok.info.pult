  ...
  return (
    <main className="min-h-screen bg-black px-4 py-8 text-white sm:px-6 md:px-8 md:py-12">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <h1 className="mb-4 text-4xl font-extrabold tracking-[0.18em] uppercase sm:text-5xl">
            {content.title}
          </h1>
        ...
        >
          <h2 className="mb-6 text-center text-2xl font-bold tracking-wide text-yellow-400 uppercase md:text-3xl">
            {content.heading}
          </h2>
          ...
          {content.cards.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <p className="mb-8 text-lg leading-8 text-gray-300">{item.text}</p>
