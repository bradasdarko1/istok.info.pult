  ...
  return (
    <main className="min-h-screen px-6 py-16 text-white">
      <div className="mx-auto max-w-5xl">
        ...
        >
          <h1 className="text-4xl font-extrabold tracking-widest sm:text-5xl">{text.title}</h1>
        ...
        <motion.div
          ...
          className="mb-10 rounded-3xl border border-white/10 bg-black/20 p-8 backdrop-blur-md md:p-10"
        >
          {/* MAP BOX */}
          <div className="mb-8 rounded-2xl border border-yellow-400/20 bg-black/20 p-8 text-center backdrop-blur-md">
          ...
          <div className="space-y-6 text-lg text-gray-300 md:text-xl">
            <div>
              <span className="font-semibold text-yellow-400">{text.addressLabel}:</span> Maksima
              Gorkog 2a, Novi Sad
            </div>

            <div>
              <span className="font-semibold text-yellow-400">{text.emailLabel}:</span>{' '}
              <a href="mailto:istokinfopult@gmail.com" className="transition hover:text-white">
                istokinfopult@gmail.com
              </a>
            </div>

            <div>
              <span className="font-semibold text-yellow-400">{text.phoneLabel}:</span>{' '}
              <a href="tel:+38166133231" className="transition hover:text-white">
                066/133-231
              </a>
            </div>
          </div>
