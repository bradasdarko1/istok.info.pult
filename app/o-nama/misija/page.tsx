    ...
    <main className="min-h-screen px-6 py-16 text-white">
      <div className="mx-auto max-w-5xl">
        ...
        <motion.section
          ...
          className="mb-14 rounded-3xl border border-white/10 bg-black/20 p-8 backdrop-blur-md md:p-10"
        >
          <h2 className="mb-6 text-2xl font-bold tracking-wide text-yellow-400 uppercase md:text-3xl">
            {content.subtitle1}
          </h2>

          <p className="text-lg leading-9 text-gray-200 md:text-xl">{content.text1}</p>
        </motion.section>
        ...
        <motion.section
          ...
          className="rounded-3xl border border-yellow-400/30 bg-black/20 p-8 text-center backdrop-blur-md md:p-12"
        >
