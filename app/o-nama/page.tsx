...
export default function ONamaPage() {
  ...
  return (
    <main className="min-h-screen px-4 py-8 text-white sm:px-6 md:px-8 md:py-12">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <h1 className="text-4xl font-extrabold tracking-[0.2em] uppercase sm:text-5xl md:text-6xl">
            {content.title}
          </h1>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            <Link
              href="/o-nama/misija"
              className="group block h-full rounded-3xl border border-white/10 bg-black/20 p-8 backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:border-yellow-400/30 hover:bg-white/10"
            >
              ...
              <p className="mb-8 text-lg leading-8 text-gray-300">{content.missionText}</p>
          ...
          >
            ...
            >
              ...
              <p className="mb-8 text-lg leading-8 text-gray-300">{content.contactText}</p>
        ...
        <motion.div
          ...
          className="mt-14 rounded-3xl border border-yellow-400/20 bg-black/20 p-8 text-center backdrop-blur-md"
        >
          <p className="text-lg font-semibold tracking-wide text-yellow-300 uppercase md:text-xl">
            {content.slogan}
          </p>
        </motion.div>
      </div>
