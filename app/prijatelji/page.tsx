      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="mb-4 text-4xl font-bold tracking-[0.18em] md:text-5xl">{t.title}</h1>

            <div className="mx-auto mb-6 h-1 w-24 rounded-full bg-yellow-400/80" />

            <p className="mb-6 text-lg font-medium text-yellow-200 md:text-xl">{t.subtitle}</p>

            <p className="mb-5 text-base leading-8 text-gray-200 md:text-lg">{t.text1}</p>

            <p className="text-base leading-8 text-gray-300 md:text-lg">{t.text2}</p>
          </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {friends.map((friend, index) => (
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-6 text-gray-400">{t.cardLabel}</p>
                </motion.a>
              ))}
            </div>
          </div>
