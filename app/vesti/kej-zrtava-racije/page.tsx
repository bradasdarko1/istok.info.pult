...
const srLatin = {
  ...
  lead: 'U subotu, 4. aprila 2026. godine, na Keju žrtava racije u Novom Sadu održan je događaj sa ciljem potpisivanja peticije za podizanje spomenika žrtvama NATO agresije.',
  paragraphs: [
...
const ruText = {
  ...
  lead: 'В субботу, 4 апреля 2026 года, на Набережной жертв рейда в Нови-Саде состоялось мероприятие с целью сбора подписей за установку памятника жертвам агрессии НАТО.',
  paragraphs: [
