...
const srLatin = {
  ...
  applicationLabel: 'Link za prijavu:',
  applicationUrl: 'https://timetoliveinrussia.com/',
...
const ruText = {
  ...
  applicationLabel: 'Ссылка для регистрации:',
  applicationUrl: 'https://timetoliveinrussia.com/',
    ...
    language === 'ru'
      ...
      : script === 'cyr'
        ? {
            ...
            applicationLabel: latinToCyrillic(srLatin.applicationLabel),
            applicationUrl: srLatin.applicationUrl,
    ...
    <main className="min-h-screen bg-black px-4 py-8 text-white sm:px-6 md:px-8 md:py-12">
      <article className="mx-auto max-w-4xl">
        ...
        >
          ...
          <div className="space-y-6 text-base leading-8 text-gray-300 md:text-lg">
            ...
            <div className="rounded-2xl border border-yellow-500/30 bg-yellow-500/10 p-5">
              ...
              <a
                ...
                className="break-all text-lg font-bold text-yellow-400 underline underline-offset-4 transition hover:text-yellow-300 md:text-xl"
              >
          ...
          <CommentsSection postSlug="rusija-otvara-vrata" />
        </motion.div>
      </article>
    </main>
  )
