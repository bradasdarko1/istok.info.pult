...
const srLatin = {
  ...
  lead: 'Posle 27 godina od NATO agresije na SRJ, pokreće se inicijativa za podizanje spomenika žrtvama NATO agresije u Novom Sadu.',
  paragraphs: [
...
const ruText = {
  ...
  lead: 'Спустя 27 лет после агрессии НАТО против Союзной Республики Югославии начинается инициатива по установке памятника жертвам агрессии НАТО в Нови-Саде.',
  paragraphs: [
      ...
      <article className="mx-auto max-w-4xl">
        ...
        >
          ...
          <div className="mt-10 rounded-2xl border border-yellow-400/30 bg-yellow-400/10 p-6 text-center">
            ...
            <CommentsSection postSlug="spomenik-27-godina" />
          </div>
        </motion.div>
      </article>
    </main>
