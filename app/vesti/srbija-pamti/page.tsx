...
export default function SrbijaPamti() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-8">
      <Link
        href="/vesti"
        className="group mb-8 inline-flex items-center gap-2 rounded-xl border border-white/20 bg-black/50 px-5 py-2.5 text-sm font-semibold text-white shadow-md backdrop-blur-md transition-all duration-300 hover:bg-white/20 hover:shadow-xl"
      >
      ...
      <article className="rounded-2xl border border-white/10 bg-black/40 p-6 shadow-xl backdrop-blur-md">
        <h1 className="mb-6 text-3xl font-black tracking-wide text-white sm:text-4xl">{title}</h1>
