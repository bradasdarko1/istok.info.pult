...
export const metadata: Metadata = {
  ...
  description:
    'Na otvorenim bazenima u Kuli 29. avgusta 2026. godine biće održano posebno veče posvećeno Kosovu i Metohiji, srpskoj istoriji, kulturi, veri i humanosti. Početak programa je u 15 časova.',
  ...
  openGraph: {
    ...
    url: 'https://istokinfopult.rs/vesti/vece-za-kosovo-i-metohiju-u-kuli',

    images: [
      {
        url: 'https://istokinfopult.rs/static/images/vece-za-kosovo.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      'https://istokinfopult.rs/static/images/vece-za-kosovo.jpg',
    ],
  },
}

export default function VeceZaKosovoIMetohijuUKuliLayout({
  children,
}: {
