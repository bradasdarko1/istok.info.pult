...
export default function ComingSoonBanner({ srTitle, ruTitle }: ComingSoonBannerProps) {
  ...
  return (
    <main className="min-h-screen bg-black px-4 py-8 text-white sm:px-6 md:px-8 md:py-12">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <h1 className="text-3xl font-extrabold tracking-wide text-white uppercase sm:text-4xl md:text-5xl">
            {content.title}
          </h1>

          <div className="mx-auto my-6 h-px w-32 bg-yellow-500/60" />

          <p className="text-2xl font-bold tracking-wide text-yellow-400 uppercase sm:text-3xl md:text-4xl">
            {content.soon}
          </p>
        </motion.section>
      </div>
