...
> = {
  siteName: {
    sr: { cyr: 'ИСТОК ИНФО ПУЛТ', lat: 'ISTOK INFO PULT' },
    ru: 'ИСТОК ИНФО ПУЛЬТ',
  },
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const storedScript = localStorage.getItem('site-script')
  ...
  const value = useMemo(
    ...
    [language, script, t, toggleLanguage, toggleScript]
  )
